...
Para la documentación directa en el código fuente del submódulo, consultar [`com.ingsis.interpreter/README.md`](../../com.ingsis.interpreter/README.md).

---

## 🔗 Dependencias del Módulo

Definidas en [`build.gradle`](../../com.ingsis.interpreter/build.gradle):
...
El intérprete implementa la interfaz [`Interpreter`](../../com.ingsis.interpreter/src/main/java/interpreter/Interpreter.java) a través de [`DefaultInterpreter`](../../com.ingsis.interpreter/src/main/java/interpreter/DefaultInterpreter.java). Admite dos modos de ejecución según los insumos provistos:
...
El intérprete no propaga excepciones no controladas; encapsula todas las respuestas en `Result<T>` estandarizando prefijos diagnósticos:

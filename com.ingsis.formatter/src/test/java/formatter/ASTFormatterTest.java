    ...
    void testYamlRulesConsigna1And2() {
        ...
        DeclarationKeywordNode decl =
                NodeFactory.createDeclaration(
                        ...
                        new token.Token(
                                token.TokenType.CONST, "const", new position.Position(1, 1)));

        node.expression.function.CallFunctionNode callThen =
                NodeFactory.createCall(
                        ...
                        new token.Token(
                                ...
                                "println",
                                new position.Position(2, 5)));

        node.keyword.IfKeywordNode ifNode =
